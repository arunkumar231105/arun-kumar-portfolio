...
const Index = () => {
  ...
  return <div className="flex flex-col min-h-screen">
      ...
      <section id="home" className="pt-32 md:pt-40 pb-16 md:pb-24 container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 animate-fade-in">
            <Badge variant="outline" className="mb-4 text-sm px-3 py-1 border-primary/30 bg-primary/5">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl">Passionate Software Engineering student with strong problem-solving skills and a keen interest in front-end and back-end development. Seeking opportunities to apply my knowledge in real-world projects and grow as a developer</p>
          ...
          <div className="lg:col-span-5 animate-slide-in">
            <div className="glass-card p-6">
              ...
              <div className="space-y-4">
                ...
                label: "Location",
                value: "Newtown Karachi Centre, Karachi, Pakistan"
              }, {
                ...
                url: "https://github.com/arunkumar231105"
                    ...
                    <div>
                      ...
                      {item.url ? <a href={item.url} target="_blank" rel="noopener noreferrer" className="font-medium hover:text-primary transition-colors">
                          {item.value}
                        </a> : <span className="font-medium">{item.value}</span>}
                    </div>
                  </div>)}
              </div>
            </div>
      ...
      <section id="skills" className="container-section bg-muted/30">
        <SectionHeading title="Skills & Expertise" subtitle="My technical skills and competencies" alignment="center" />
        ...
        }].map((skill, index) => <SkillCard key={index} icon={skill.icon} title={skill.title} description={skill.description} className="animate-fade-in" style={{
      ...
      <section id="education" className="container-section">
        ...
        <div className="glass-card p-8 animate-fade-in">
          <TimelineItem title="BS – Software Engineering" subtitle="SZABIST Karachi Campus" date="2023-2027" description="Currently pursuing a bachelor's degree in Software Engineering, focusing on programming fundamentals, software design principles, and practical application development." isLast={true} />
        </div>
      </section>
      
      {/* Experience Section */}
      <section id="experience" className="container-section bg-muted/30">
        <SectionHeading title="Professional Experience" subtitle="My internships and work history" />
        
        <div className="glass-card p-8 animate-fade-in">
          <TimelineItem title="Java Intern" subtitle="Codsoft Company (Virtual)" date="07/2024 – 08/2024" description={["Developed Java applications with a focus on object-oriented programming", "Enhanced data structures and algorithms skills through practical implementation", "Engaged in debugging and code optimization exercises", "Collaborated with team members on virtual projects"]} />
          
          <TimelineItem title="C++ Intern" subtitle="Code Alpha (Virtual)" date="06/2024 – 07/2024" description={["Built real-world C++ applications from concept to implementation", "Improved problem-solving skills through algorithm challenges", "Gained experience in software lifecycle management", "Implemented best practices for clean, maintainable code"]} isLast={true} />
        </div>
      </section>
      
      {/* Projects Section */}
      <section id="projects" className="container-section">
        <SectionHeading title="Projects" subtitle="A showcase of my recent work and creations" alignment="center" />
        ...
        }].map((project, index) => <ProjectCard key={index} title={project.title} description={project.description} tags={project.tags} className="animate-fade-in" style={{
          animationDelay: `${index * 0.1}s`
        }} />)}
        </div>
      ...
      <section id="organizations" className="container-section bg-muted/30">
        <SectionHeading title="Organizations & Leadership" subtitle="My contributions to communities and organizations" />
        
        <div className="glass-card p-8 animate-fade-in">
          <TimelineItem title="IEEE Society - SZABIST" subtitle="Assistant Director" date="09/2024 – Present" description={["Organized Git/GitHub workshops for students to enhance version control skills", "Led programming fundamentals sessions focused on Java and C++", "Coordinated team projects and initiatives to promote technical learning", "Contributed to increasing society engagement and membership"]} />
          
          <TimelineItem title="DHoR (Development of Human Resources)" subtitle="Volunteer Member" date="2022 – 2023" description={["Assisted underprivileged students in educational initiatives", "Participated in community outreach programs", "Represented the organization at Educational Expos (2022 & 2023)", "Helped develop educational resources for community programs"]} isLast={true} />
        </div>
      </section>
      
      {/* Awards & Certifications Section */}
      <section id="awards" className="container-section">
        <SectionHeading title="Awards & Certifications" subtitle="Recognition of my achievements and skills" />
      ...
      <section id="contact" className="container-section bg-muted/30">
        <SectionHeading title="Contact Me" subtitle="Get in touch for collaborations or opportunities" alignment="center" />
