  ...
  return <div className="flex flex-col min-h-screen">
      ...
      <section id="skills" className="container-section bg-muted/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          description: "Experience with HTML, CSS, and JavaScript to create responsive and interactive web applications with modern frameworks."
        }, {
          ...
          description: "Knowledge of PostgreSQL for database design, management, and optimization to support application data needs."
        }, {
      ...
      <section id="experience" className="container-section bg-muted/30">
        ...
        <div className="glass-card p-8 animate-fade-in">
          <TimelineItem title="Remote Internships" subtitle="CodSoft & Code Alpha" date="06/2024 – 08/2024" description={[
      ...
      <section id="projects" className="container-section">
        ...
        ].map((project, index) => <ProjectCard key={index} title={project.title} description={project.description} tags={project.tags} repoUrl={project.repoUrl} className="animate-fade-in" style={{
          animationDelay: `${index * 0.1}s`
        }} />)}
        </div>
